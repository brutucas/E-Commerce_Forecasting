...
- (Optional) Visual depictions of seasonality (as measured by Google Search traffic) that are of interest to the company.

- (Optional) An evaluation of how the company stock price correlates to its Google Search traffic.
...
- Step 2 (Optional): Mine the search traffic data for seasonality.

- Step 3 (Optional): Relate the search traffic to stock price patterns.
